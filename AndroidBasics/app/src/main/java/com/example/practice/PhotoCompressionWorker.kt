...
class PhotoCompressionWorker(
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            val stringUri = param.inputData.getString(KEY_CONTENT_URI)
            val compressionThresholdInByte = param.inputData.getLong(KEY_COMPRESSION_THRESHOLD, 0L)
            ...
            } while (outputByte.size > compressionThresholdInByte && quality > 5)
